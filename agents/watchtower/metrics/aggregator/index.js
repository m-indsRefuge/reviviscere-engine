// +++ NEW: Define the Time-To-Live for raw metrics in seconds +++
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/ingest" && request.method === "POST") {
      try {
        ...
        // +++ MODIFIED: Added expirationTtl to the put operation +++
        // Store the full metrics data under its job-specific key with a 7-day TTL
